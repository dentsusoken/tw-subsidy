...
const AccountListDetailMain = () => {
  ...
  // recoil
  const [reqList, setReqList] = useRecoilState(accountReqList2State);
  const [vcList, setVCList] = useRecoilState(accountVCList2State);
  // states
          ...
          {appInfo ? (
            <>
              ...
              <div className="py-0 px-[53px]">
                {appInfo && isAccountContent(appInfo.req.payload) && (
                  <AccountDetail input={appInfo.req.payload} />
                )}
