                ...
                {VCRequest && (
                  ...
                  >
                    ...
                    {vcStatus.issuedStatus ? (
                      ...
                      <p
                        className={
                          'text-sm text-color-required leading-relaxed'
                        }
                      >
                        未承認
                      </p>
                    ...
                    <p
                      className={
                        'text-xs text-color-gray-search leading-relaxed'
                      }
                    >
                      申請日{' '}
                      {dayjs(VCRequest.applicationDate).format(
                        'YY/MM/DD HH:mm'
                      )}
                    </p>
                  </section>
                  ...
                  <ul className={'mt-7 ml-3'}>
                    <li className={'py-3 pl-4 pr-6 w-78 flex relative'}>
                      <input
                        ...
                        disabled={true}
                        value={`住民票 - VC${
                          parseInt(VCRequest.residentVC) + 1
                        }`}
                      />
                      {residentVerifyStatus ? (
                        <img
                    ...
                    <li className={'py-3 pl-4 pr-6 w-78 flex relative'}>
                      <input
                        ...
                        disabled={true}
                        value={`口座実在証明証 - VC${
                          parseInt(VCRequest.accountVC) + 1
                        }`}
                      />
                      {accountVerifyStatus ? (
                        <img
